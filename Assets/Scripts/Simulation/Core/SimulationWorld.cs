...
namespace LifeSimulation.Simulation.Core
{
    public sealed partial class SimulationWorld
    {
        ...
        public SimulationWorld(SimulationConfig config)
        {
            ...
            _reproduction = new ReproductionSystem(Creatures, Arena, Config.InitialPopulation, Config.PhysiologyEnabled, Config.MateSelectionEnabled, Config.ReproductionNeedFraction, Config.GradedFertilityEnabled);
