...
{
    public static class CognitionFounderFactory
    {
        ...
        {
            return DeterministicRandom.Float01(worldSeed, RandomDomain.FounderGenome, founderOrdinal, traitIndex, 3, 36 + traitIndex);
        }
