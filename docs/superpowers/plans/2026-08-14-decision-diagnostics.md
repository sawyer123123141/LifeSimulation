...
**Related:** defect A-2 in `docs/superpowers/specs/2026-08-14-simulation-defects-and-behavior-gaps.md`. Sibling plan: `2026-08-14-death-causes.md` (independent — either may be done first).
